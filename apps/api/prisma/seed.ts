      ...
      ticketTypes: [
        {
          ...
          priceSompi: 500_000,
          supply: 40,
          metadataUri: 'https://picsum.photos/seed/aurora-vip-pkg/1200/1600',
          perk: {
            section: 'VIP',
            row: 'L',
            seatNumber: '1-40',
            soundcheckAccess: true,
            backstageTour: true,
          },
        },
        {
          ...
          priceSompi: 430_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/aurora-plat-floor/1200/1600',
          perk: { section: 'PLAT', row: 'A', seatNumber: '1-50' },
        },
        {
          code: 'GOLDR',
          name: 'Gold Reserved',
          priceSompi: 350_000,
          supply: 70,
          metadataUri: 'https://picsum.photos/seed/aurora-gold-r/1200/1600',
          perk: { section: 'R', row: 'B', seatNumber: '1-70' },
        },
        {
          code: 'SILVERS',
          name: 'Silver Reserved',
          priceSompi: 270_000,
          supply: 80,
          metadataUri: 'https://picsum.photos/seed/aurora-silver-s/1200/1600',
          perk: { section: 'S', row: 'C', seatNumber: '1-80' },
        },
        {
          code: 'BRONZEA',
          name: 'Bronze Arena',
          priceSompi: 190_000,
          supply: 70,
          metadataUri: 'https://picsum.photos/seed/aurora-bronze-a/1200/1600',
          perk: { section: 'A', row: 'D', seatNumber: '1-70' },
        },
        {
          code: 'VIEWB',
          name: 'Side View B',
          priceSompi: 120_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/aurora-view-b/1200/1600',
          perk: { section: 'B', row: 'E', seatNumber: '1-50' },
        },
      ],
    },
  },
      ...
      ticketTypes: [
        {
          ...
          priceSompi: 490_000,
          supply: 30,
          metadataUri: 'https://picsum.photos/seed/neon-pit-vip/1200/1600',
          perk: { section: 'PIT', row: 'A', seatNumber: '1-30', fastLane: true },
        },
        {
          code: 'STAGEA',
          name: 'Stage Side A',
          priceSompi: 410_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/neon-stage-a/1200/1600',
          perk: { section: 'A', row: 'B', seatNumber: '1-50' },
        },
        {
          code: 'STAGER',
          name: 'Reserved R',
          priceSompi: 320_000,
          supply: 60,
          metadataUri: 'https://picsum.photos/seed/neon-stage-r/1200/1600',
          perk: { section: 'R', row: 'C', seatNumber: '1-60' },
        },
        {
          code: 'STAGES',
          name: 'Standard S',
          priceSompi: 250_000,
          supply: 70,
          metadataUri: 'https://picsum.photos/seed/neon-stage-s/1200/1600',
          perk: { section: 'S', row: 'D', seatNumber: '1-70' },
        },
        {
          code: 'TERRACE',
          ...
          priceSompi: 170_000,
          supply: 60,
          metadataUri: 'https://picsum.photos/seed/neon-terrace/1200/1600',
          perk: { section: 'T', row: 'E', seatNumber: '1-60' },
        },
        {
          code: 'SKYVIEW',
          name: 'Sky View',
          priceSompi: 110_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/neon-sky-view/1200/1600',
          perk: { section: 'SV', row: 'F', seatNumber: '1-50' },
        },
      ],
    },
  },
      ...
      ticketTypes: [
        {
          ...
          priceSompi: 450_000,
          supply: 60,
          metadataUri: 'https://picsum.photos/seed/river-fest-vip/1200/1600',
        ...
        },
        {
          ...
          priceSompi: 380_000,
          supply: 80,
          metadataUri: 'https://picsum.photos/seed/river-lounge/1200/1600',
          perk: { section: 'LT', seat: 'Terrace Lounge' },
        },
        {
          code: 'DAYZONEA',
          name: 'Day Zone A',
          priceSompi: 290_000,
          supply: 100,
          metadataUri: 'https://picsum.photos/seed/river-day-zone-a/1200/1600',
          perk: { section: 'DZ-A', seat: 'Open Standing Zone A' },
        },
        {
          code: 'DAYZONEB',
          name: 'Day Zone B',
          priceSompi: 220_000,
          supply: 100,
          metadataUri: 'https://picsum.photos/seed/river-day-zone-b/1200/1600',
          perk: { section: 'DZ-B', seat: 'Open Standing Zone B' },
        },
        {
          code: 'NIGHTA',
          name: 'Night Stage A',
          priceSompi: 160_000,
          supply: 100,
          metadataUri: 'https://picsum.photos/seed/river-night-a/1200/1600',
          perk: { section: 'N-A', seat: 'Night Stage Standing A' },
        },
        {
          code: 'NIGHTB',
          name: 'Night Stage B',
          priceSompi: 100_000,
          supply: 80,
          metadataUri: 'https://picsum.photos/seed/river-night-b/1200/1600',
          perk: { section: 'N-B', seat: 'Night Stage Standing B' },
        },
      ],
    },
  },
      ...
      ticketTypes: [
        {
          ...
          priceSompi: 500_000,
          supply: 20,
          metadataUri: 'https://picsum.photos/seed/strings-royal-box/1200/1600',
          perk: { section: 'BOX', row: 'A', seatNumber: '1-20' },
        },
        {
          code: 'ORCHPREM',
          ...
          priceSompi: 420_000,
          supply: 30,
          metadataUri: 'https://picsum.photos/seed/strings-orch-prem/1200/1600',
          perk: { section: 'ORCH', row: 'B', seatNumber: '1-30' },
        },
        {
          code: 'ORCHSTD',
          ...
          priceSompi: 320_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/strings-orch-std/1200/1600',
          perk: { section: 'ORCH', row: 'D', seatNumber: '1-50' },
        },
        {
          code: 'MEZZA',
          name: 'Mezzanine A',
          priceSompi: 240_000,
          supply: 60,
          metadataUri: 'https://picsum.photos/seed/strings-mezz-a/1200/1600',
          perk: { section: 'MEZZ-A', row: 'F', seatNumber: '1-60' },
        },
        {
          code: 'MEZZB',
          name: 'Mezzanine B',
          priceSompi: 170_000,
          supply: 70,
          metadataUri: 'https://picsum.photos/seed/strings-mezz-b/1200/1600',
          perk: { section: 'MEZZ-B', row: 'G', seatNumber: '1-70' },
        },
        {
          code: 'BALC',
          name: 'Balcony',
          priceSompi: 110_000,
          supply: 50,
          metadataUri: 'https://picsum.photos/seed/strings-balc/1200/1600',
          perk: { section: 'BALC', row: 'H', seatNumber: '1-50' },
        },
      ],
    },
  },
...
async function main() {
  ...
  console.log(`  - Ticket types seeded: ${globalTicketTypeCounter}`)
